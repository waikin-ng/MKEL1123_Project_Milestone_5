...
inline double get_last_x_angle() {return last_x_angle;}
inline double get_last_y_angle() {return last_y_angle;}
inline double get_last_z_angle() {return last_z_angle;}
